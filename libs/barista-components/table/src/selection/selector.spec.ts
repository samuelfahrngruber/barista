...
describe('DtTableSelection', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DtTableSelectionComponentForTesting);
  ...
  it('should show the header checkbox in the correct state when selecting programmatically', () => {
    ...
    component.tableSelection.select(component.dataSource[1]);
    fixture.detectChanges();
  ...
  it('should have the correct states for selected', () => {
    expect(component.tableSelection.selected).toEqual([{ host: 'host4' }]);

    expect(
      component.tableSelection.isSelected({
        host: 'host4',
      }),
    ).toBeTruthy();
    ...
    expect(component.tableSelection.selected).toEqual([
      {
        host: 'host4',
      },
      {
...
@Component({
  ...
  template: ` <dt-table
    ...
    dtTableSelection
    [dtTableSelectionSelected]="[{ host: 'host4' }]"
    dtSort
  >
